...
public class LoginActivity extends BaseActivity implements View.OnClickListener{
    ...
    private void saveToSharedPreferences() {
        SharedPreferences userSP = getSharedPreferences(Constants.SHARED_PREFERENCES_SAVE_LOGIN_NAME, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = userSP.edit();
        editor.putString(Constants.SHARED_PREFERENCES_SAVE_LOGIN_EMAIL,mEtEmail.getText().toString());
        editor.putString(Constants.SHARED_PREFERENCES_SAVE_LOGIN_PASSWORD, mEtPassword.getText().toString());
        editor.putBoolean(Constants.SHARED_PREFERENCES_SAVE_LOGIN_SW_IS_CHECKED,mSwRememberMe.isChecked());
        editor.apply();
    }

    private void loadFromSharedPreferences() {
        SharedPreferences userSP = getSharedPreferences(Constants.SHARED_PREFERENCES_SAVE_LOGIN_NAME,Context.MODE_PRIVATE);
        if(userSP.contains(Constants.SHARED_PREFERENCES_SAVE_LOGIN_EMAIL)){
            mEtEmail.setText(userSP.getString(Constants.SHARED_PREFERENCES_SAVE_LOGIN_EMAIL,""));
            mEtPassword.setText(userSP.getString(Constants.SHARED_PREFERENCES_SAVE_LOGIN_PASSWORD,""));
            mSwRememberMe.setChecked(userSP.getBoolean(Constants.SHARED_PREFERENCES_SAVE_LOGIN_SW_IS_CHECKED,false));
        }
    }
